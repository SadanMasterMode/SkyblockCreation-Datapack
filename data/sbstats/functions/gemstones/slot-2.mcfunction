data modify storage sbstats:data BaseGemstoneData set from storage sbstats:data PlayerData.SelectedItem.tag.Base.Gemstones[1]
data modify storage sbstats:data UpgradeGemstoneData set from storage sbstats:data PlayerData.SelectedItem.tag.Upgrades.Gemstones[1]
