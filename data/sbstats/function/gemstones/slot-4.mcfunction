data modify storage sbstats:data BaseGemstoneData set from storage sbstats:data PlayerData.SelectedItem.components."minecraft:custom_data".Base.Gemstones[3]
data modify storage sbstats:data UpgradeGemstoneData set from storage sbstats:data PlayerData.SelectedItem.components."minecraft:custom_data".Upgrades.Gemstones[3]
