data modify storage sbstats:data BaseGemstoneData set from storage sbstats:data PlayerData.SelectedItem.components."minecraft:custom_data".Base.Gemstones[2]
data modify storage sbstats:data UpgradeGemstoneData set from storage sbstats:data PlayerData.SelectedItem.components."minecraft:custom_data".Upgrades.Gemstones[2]
...
### Opal
execute if data storage sbstats:data {BaseGemstoneData:{id:'UNIVERSAL'}} if data storage sbstats:data {UpgradeGemstoneData:{Applied:1b}} if data storage sbstats:data {UpgradeGemstoneData:{id:'OPAL'}} run data modify storage sbstats:data GemstoneBuilder append value '{"text":"❂","color":"white"}'
