# Get H/FPB count
execute store result score #HPB modifiers run data get storage sbstats:data PlayerData.SelectedItem.components."minecraft:custom_data".Upgrades.HotPotatoBooks
execute store result score #FPB modifiers run data get storage sbstats:data PlayerData.SelectedItem.components."minecraft:custom_data".Upgrades.FumingPotatoBooks
