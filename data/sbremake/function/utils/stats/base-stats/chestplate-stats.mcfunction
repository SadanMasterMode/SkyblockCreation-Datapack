# Chestplate Stats
data modify storage sbremake:data ChestplateData set from storage sbremake:data PlayerData.Inventory[{Slot:102b}].components."minecraft:custom_data".Base.stats
