# Helmet Stats
data modify storage sbremake:data HelmetData set from storage sbremake:data PlayerData.Inventory[{Slot:103b}].components."minecraft:custom_data".Base.stats
