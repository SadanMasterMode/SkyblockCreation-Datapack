...
execute if score @s dhGleamingSpawn matches 100 run data merge entity @e[type=item,nbt={Item:{id:"minecraft:golden_sword",count:1b,components:{"minecraft:custom_data":{Base:{id:'GLEAMING_BLADE'}}}}},limit=1] {PickupDelay:60s,Tags:["float"],Motion:[0,0,0],Glowing:1b,Air:10s}
