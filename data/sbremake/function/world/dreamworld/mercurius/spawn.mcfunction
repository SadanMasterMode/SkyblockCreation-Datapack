...
execute in sbremake:dreamworld run kill @e[tag=cryingOrbIcicle]
...
execute in sbremake:dreamworld run summon magma_cube 100 42.2 88 {Size:0,NoAI:1b,NoGravity:1b,Invulnerable:1b,Tags:["spectator","stalkerEyeMarker","noName","invulnerable"],active_effects:[{id:"invisibility",duration:2147483647,amplifier:1,show_particles:0b},{id:"resistance",duration:2147483647,amplifier:5,show_particles:0b},{id:"regeneration",amplifier:100,duration:2147483647,show_particles:0b}],Attributes:[{Name:"minecraft:generic.max_health",Base:1024d}],Health:1024f}
