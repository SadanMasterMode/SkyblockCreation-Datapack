...
execute if entity @e[tag=witherborn] at @a as @e[distance=..12,tag=!spectator,limit=1,sort=nearest] unless entity @e[tag=witherbornMarked,limit=1] run tag @s add witherbornMarked
