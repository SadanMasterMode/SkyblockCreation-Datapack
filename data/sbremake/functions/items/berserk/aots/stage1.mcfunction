...
data modify storage sbremake:data Actionbar.AbilityUsage set value '[{"text":"-20 Mana (","color":"aqua"},{"text":"Throw","color":"gold"},{"text":")   ","color":"aqua"}]'
