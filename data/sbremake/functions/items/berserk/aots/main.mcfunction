...
execute if score @s[scores={mana=..19}] aotsStage matches 0 run function sbremake:items/berserk/aots/mana
execute if score @s[scores={mana=..39}] aotsStage matches 1 run function sbremake:items/berserk/aots/mana
execute if score @s[scores={mana=..79}] aotsStage matches 2 run function sbremake:items/berserk/aots/mana
