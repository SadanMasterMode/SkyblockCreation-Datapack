...
execute if score #juju-cd fakePlayers >= #juju-max-cd fakePlayers anchored eyes positioned ^ ^ ^0.5 run summon arrow ~ ~ ~ {Tags:["projectile","spectator","juju"],damage:0,crit:0b,pickup:0b,Passengers:[{id:"minecraft:marker",Tags:["spectator","juju"]}]}
