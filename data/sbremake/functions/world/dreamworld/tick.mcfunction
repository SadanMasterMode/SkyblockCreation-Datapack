...
execute if entity @a[predicate=sbremake:world/mercurius/dimension_check,limit=1] in sbremake:dreamworld as @e[tag=bob] unless score #2 life matches 1.. run function sbremake:world/dreamworld/mercurius/crystal/tick
